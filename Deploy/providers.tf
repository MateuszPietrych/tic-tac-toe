...
terraform {
  ...
  required_providers {
    aws = {
      # atrybut w bloku aws, który określa źródło dostawcy. W tym przypadku jest to "hashicorp/aws", co oznacza, 
      ...
      # W tym przypadku "~> 4.67.0" oznacza, że Terraform będzie korzystać z wersji dostawcy AWS w zakresie od 4.67.0.
      version = "~> 4.67.0"
    }
  }
